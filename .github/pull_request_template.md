...
<!-- What does this change establish? -->

## Foundation impact

- [ ] No change to the accepted theory
- [ ] Changes or clarifies a kernel rule
- [ ] Adds or changes an extension
...
Disclose material use of tactics, external solvers, code generators, or AI
systems. Provenance does not determine validity, but it supports
